import { aw as defineComponent, ax as ref, az as computed, aM as Gt, ar as openBlock, as as createElementBlock, at as createBaseVNode, aH as createVNode, aG as withCtx, aA as normalizeClass, aJ as toDisplayString, aF as resolveComponent, aE as createBlock } from "./vendor.4f3827aa.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
const solarPanel = "/cooperation_jn_solar/issue-341-simulation-result-component/assets/solar-panel.cbe5f820.svg";
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { props, currentNumSolarPanel, decreaseCurrenNumSolarPanel, increaseCurrenNumSolarPanel, currentSurface, currentPower, get UiIconButton() {
      return Gt;
    }, get solarPanel() {
      return solarPanel;
    } };
...
const _hoisted_1 = { class: "box-border flex flex-col p-5 border-[1px] border-slate-200 rounded-lg" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      createVNode($setup["UiIconButton"], {
        class: normalizeClass([
          ...
          $setup.currentNumSolarPanel == 0 ? "border-neutral-300" : "border-black"
        ]),
        onClick: $setup.decreaseCurrenNumSolarPanel,
        disabled: $setup.currentNumSolarPanel == 0
      }, {
        default: withCtx(() => [
          (openBlock(), createElementBlock("svg", _hoisted_3, [
            createBaseVNode("path", {
              d: "M0.714355 1H19.2858",
              stroke: $setup.currentNumSolarPanel == 0 ? "#D4D4D4" : "black",
    ...
    createBaseVNode("div", _hoisted_16, [
      ...
      createBaseVNode("div", _hoisted_20, [
        _hoisted_21,
        createBaseVNode("p", _hoisted_22, toDisplayString($setup.props.roofSurface ? $setup.props.roofSurface.incliniasion : "N/A") + "\xB0 ", 1)
      ]),
