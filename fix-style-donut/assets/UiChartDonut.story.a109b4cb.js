import { aw as defineComponent, ax as ref, az as computed, aF as resolveComponent, ar as openBlock, as as createElementBlock, at as createBaseVNode, aJ as toDisplayString, aH as createVNode, aE as createBlock, aG as withCtx, aM as VueApexCharts } from "./vendor.b20827f2.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { props, series, chartOptions, labelFormatted };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1 = { class: "relative" };
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("div", { class: "absolute z-5 top-[30px] left-[115px] w-[60px] h-[110px] bg-slate-100 rounded-r-full" }, null, -1);
const _hoisted_3 = { class: "absolute top-10 left-20" };
const _hoisted_4 = { class: "text-center" };
const _hoisted_5 = { class: "font-dm-sans font-bold text-3xl" };
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("span", { class: "font-dm-sans font-bold text-xl" }, " % ", -1);
  ...
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_3, [
      createBaseVNode("div", _hoisted_4, [
        createBaseVNode("span", _hoisted_5, toDisplayString($setup.props.dataGraph.labelTotalValue), 1),
        _hoisted_6
      ]),
