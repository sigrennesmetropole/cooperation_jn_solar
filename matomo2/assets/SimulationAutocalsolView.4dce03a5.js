import { as as defineComponent, ay as ref, aF as computed, aw as openBlock, aA as createElementBlock, aB as createBaseVNode, aH as normalizeClass, bh as withDirectives, bi as vModelText, aD as createCommentVNode, ax as createVNode, av as withCtx, aC as createTextVNode, az as useRouter, bd as onBeforeMount, bc as reactive, a$ as onMounted, aL as toDisplayString, au as createBlock } from "./vendor.da1b6b85.js";
...
import { q as qualitenr, a as qualibat, b as qualifelec, L as LargeFooter } from "./LargeFooter.e9af5fae.js";
...
import "./layers.245f468a.js";
import { a as SOLAR_PANEL_POWER } from "./solarPanel.model.5b355558.js";
import { u as useSolarPanelStore, a as apiService } from "./solarPanels.ae657700.js";
import { u as usePanelsStore } from "./panels.837089d5.js";
const deleteCircle = "/cooperation_jn_solar/matomo2/assets/interface-delete-circle.fdda9bfe.svg";
...
const _hoisted_4$3 = { class: "flex flex-col gap-1.5 relative" };
...
const Animation = "/cooperation_jn_solar/matomo2/assets/loading_L.3dee35f4.gif";
...
const fail = "/cooperation_jn_solar/matomo2/assets/fail.cf81de51.svg";
...
const _hoisted_1$2 = { class: "flex flex-col gap-6 w-[640px] h-fit bg-white rounded-xl p-6 mx-auto shadow-md" };
const _hoisted_2$2 = { class: "flex flex-col items-center gap-6" };
const _hoisted_3$2 = ["src"];
const _hoisted_4$2 = /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-col gap-2" }, [
...
const messageWarning = "/cooperation_jn_solar/matomo2/assets/chat-message-warning.ded597ad.svg";
...
const _hoisted_4$1 = { class: "flex gap-11 h-[76px]" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { viewStore, addressStore, roofsStore, consumptionAndProductionStore, autocalsolStore, router, panelsStore, get isAutocalsolError() {
      ...
      isAutocalsolError = v;
    }, isAutocalsolResult, state, callAutocalsolApi, WaitingAnimation, FailComponent, CertifiedInstaller, LargeFooter, get legalList() {
      return legalList;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
const _hoisted_3 = { class: "flex flex-col gap-12 w-[640px] h-[600px] bg-white rounded-xl p-8 mx-auto mt-[104px] shadow-md" };
const _hoisted_4 = { class: "mx-16 py-10" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", _hoisted_2, [
      createBaseVNode("div", _hoisted_3, toDisplayString($setup.state.dataAutocalsol), 1),
