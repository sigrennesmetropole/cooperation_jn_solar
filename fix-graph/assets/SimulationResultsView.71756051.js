import { as as defineComponent, aw as openBlock, aA as createElementBlock, aB as createBaseVNode, aL as toDisplayString, aC as createTextVNode, aJ as renderSlot, ax as createVNode, av as withCtx, bd as onBeforeMount, aF as computed, at as resolveComponent, aS as Fragment, bj as createStaticVNode, au as createBlock, aD as createCommentVNode } from "./vendor.2da8e0a3.js";
import { u as useViewsStore, v as viewList } from "./views.model.d37d8e61.js";
import { u as useRoofsStore } from "./roof.ac40dce1.js";
import { b as apiService, u as useConsumptionAndProductionStore, a as useAutocalsolStore } from "./consumptionAndProduction.0175b461.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import { g as goToBlack } from "./expand-small-bigger-retract-smaller-big.36b4ec1e.js";
import { q as qualitenr, a as qualibat, b as qualifelec, w as warning, L as LargeFooter } from "./LargeFooter.a826fb44.js";
import { p as potentiel } from "./potentiel.320635bc.js";
import { u as useAddressStore } from "./address.dbe7e023.js";
import { R as RoofInformationsBox } from "./RoofInformationsBox.029fbf88.js";
import { e as economies } from "./economies.0397e19a.js";
import { u as useDistrictStore } from "./districtInformations.bfb17aae.js";
...
const _hoisted_1$b = { class: "flex flex-col gap-2 w-[100%] h-fit bg-white rounded-xl p-6 mx-auto shadow-md" };
const _hoisted_2$b = /* @__PURE__ */ createBaseVNode("p", { class: "font-dm-sans font-bold text-base" }, "Votre consommation actuelle", -1);
const _hoisted_3$b = {
  id: "consumptionValue",
...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$b, [
    _hoisted_2$b,
    createBaseVNode("p", _hoisted_3$b, toDisplayString($setup.consumptionAndProductionStore.annualConsumption) + " kWh/an ", 1)
  ]);
}
_sfc_main$b.__file = "src/components/results/ConsumptionInformation.vue";
const ConsumptionInformation = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/ConsumptionInformation.vue"]]);
const photoVoltaique = "/cooperation_jn_solar/fix-graph/assets/photo_voltaique.4f440c12.svg";
const goToWhite = "/cooperation_jn_solar/fix-graph/assets/icon-external-link-white-thin.77357ea3.svg";
...
const _hoisted_1$a = { class: "flex flex-row gap-8 w-[100%] h-fit bg-white" };
const _hoisted_2$a = { class: "flex flex-row w-[50%] justify-center h-fit border border-neutral-300 rounded-lg px-5 py-8" };
...
_sfc_main$a.__file = "src/components/results/PhotoVoltaique.vue";
const PhotoVoltaique = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/PhotoVoltaique.vue"]]);
...
const _hoisted_1$9 = { class: "flex flex-col gap-6 w-[100%] bg-slate-100 rounded-lg p-6 mx-auto" };
const _hoisted_2$9 = { class: "flex flex-row" };
const _hoisted_3$9 = { class: "underline decoration-1 font-medium text-base" };
    ...
    createBaseVNode("div", _hoisted_2$9, [
      createBaseVNode("p", _hoisted_3$9, [
        createBaseVNode("a", {
          ...
          target: "_blank"
        }, " Acc\xE9der \xE0 la page ", 8, _hoisted_4$9)
      ]),
      createBaseVNode("a", {
        href: $setup.props.link,
        target: "_blank"
...
_sfc_main$9.__file = "src/components/results/LabelsProfitability.vue";
const LabelsProfitability = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/LabelsProfitability.vue"]]);
const qualiLabels = "/cooperation_jn_solar/fix-graph/assets/quali_labels.18f84d27.svg";
const profitability = "/cooperation_jn_solar/fix-graph/assets/profitability.b54a88ee.svg";
...
const _hoisted_2$8 = /* @__PURE__ */ createBaseVNode("h2", { class: "font-dm-sans font-bold text-2xl" }, " Plus d'informations pour concr\xE9tiser votre projet ", -1);
const _hoisted_3$8 = { class: "flex flex-row gap-8" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$8, [
    ...
    createBaseVNode("div", _hoisted_3$8, [
      createVNode($setup["LabelsProfitability"], { link: "https://www.photovoltaique.info/fr/preparer-un-projet/quelles-demarches-realiser/choisir-son-installateur/#signes_de_qualite" }, {
        img: withCtx(() => [
          createBaseVNode("img", { src: $setup.qualiLabels }, null, 8, _hoisted_4$8)
        ]),
        title: withCtx(() => [
          _hoisted_5$7
        ]),
...
_sfc_main$8.__file = "src/components/results/GoFurther.vue";
const GoFurther = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$8], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/GoFurther.vue"]]);
const goToAmber = "/cooperation_jn_solar/fix-graph/assets/icon-external-link-amber.ef102a2b.svg";
const information = "/cooperation_jn_solar/fix-graph/assets/icon-information-grey.353858a2.svg";
const energies = "/cooperation_jn_solar/fix-graph/assets/energies.d96e6fdb.svg";
...
const _hoisted_2$7 = /* @__PURE__ */ createBaseVNode("h2", { class: "font-dm-sans font-bold text-2xl" }, " Contacter des associations locales ", -1);
const _hoisted_3$7 = { class: "flex flex-row gap-8 w-[100%] h-fit bg-white" };
const _hoisted_4$7 = { class: "flex flex-row w-[50%] justify-center h-fit border border-neutral-300 rounded-lg px-5 py-[18px]" };
...
_sfc_main$7.__file = "src/components/results/EnergiesRennes.vue";
const EnergiesRennes = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/EnergiesRennes.vue"]]);
const solarCoop = "/cooperation_jn_solar/fix-graph/assets/solar-coop.98d55091.svg";
...
const _hoisted_2$6 = /* @__PURE__ */ createBaseVNode("h2", { class: "font-dm-sans font-bold text-2xl" }, " \xCAtre accompagn\xE9 dans mon projet ", -1);
const _hoisted_3$6 = { class: "flex flex-row gap-8 w-[100%] h-fit bg-white" };
const _hoisted_4$6 = { class: "flex flex-row w-[50%] justify-center h-fit border border-neutral-300 rounded-lg px-5 py-8" };
...
_sfc_main$6.__file = "src/components/results/SolarCoop.vue";
const SolarCoop = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/SolarCoop.vue"]]);
...
const _hoisted_1$5 = { class: "flex flex-col gap-3 w-full h-fit bg-white rounded-xl p-6 mx-auto shadow-md font-dm-sans" };
const _hoisted_2$5 = { class: "flex flex-row justify-center items-center gap-2" };
const _hoisted_3$5 = ["src"];
const _hoisted_4$5 = /* @__PURE__ */ createBaseVNode("span", { class: "font-bold text-2xl" }, " Votre ensoleillement ", -1);
...
_sfc_main$5.__file = "src/components/results/SunshineInformation.vue";
const SunshineInformation = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/SunshineInformation.vue"]]);
const electricityProduction = "/cooperation_jn_solar/fix-graph/assets/electricity-production.9c5b9609.svg";
const equalCircle = "/cooperation_jn_solar/fix-graph/assets/equal-circle.e63a7b98.svg";
const plusCircle = "/cooperation_jn_solar/fix-graph/assets/plus-circle.06d4a9d9.svg";
...
const _hoisted_1$4 = { class: "flex flex-col mt-5 items-center" };
const _hoisted_2$4 = ["src"];
const _hoisted_3$4 = { class: "flex flex-row relative mb-5" };
const _hoisted_4$4 = { class: "absolute left-[212px] top-[80px] z-30" };
...
_sfc_main$4.__file = "src/components/results/AutocalsolResultGlobal.vue";
const AutocalsolResultGlobal = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/AutocalsolResultGlobal.vue"]]);
...
const _hoisted_1$3 = { class: "flex flex-row px-4 py-[19px] gap-3 bg-amber-50 border border-amber-200 font-dm-sans text-amber-900 rounded-lg font normal text-sm" };
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$3, [
    ...
    createBaseVNode("p", null, [
      ...
      createBaseVNode("span", _hoisted_3$3, toDisplayString($setup.districtStore.districtNumberInstallations), 1),
      createTextVNode(" sites de production photovolta\xEFque repr\xE9sentant annuellement "),
      createBaseVNode("span", _hoisted_4$3, toDisplayString($setup.keepDecimals($setup.districtStore.districtProduction, 1)) + " MWh.", 1)
    ])
  ]);
}
_sfc_main$3.__file = "src/components/results/NeighbourhoodData.vue";
const NeighbourhoodData = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/NeighbourhoodData.vue"]]);
...
const sun = "/cooperation_jn_solar/fix-graph/assets/sun.4d65a1b2.svg";
const moon = "/cooperation_jn_solar/fix-graph/assets/moon.814eba27.svg";
...
const _hoisted_1$1 = { class: "flex flex-col gap-6 w-[100%] h-fit bg-white rounded-xl p-6 shadow-md" };
