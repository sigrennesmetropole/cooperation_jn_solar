import { as as defineComponent, aH as computed, aP as jt, aw as openBlock, aB as createElementBlock, aC as createBaseVNode, ax as createVNode, av as withCtx, aJ as normalizeClass, aM as toDisplayString } from "./vendor.ef1f2ae1.js";
...
const SimulationResult_vue_vue_type_style_index_0_lang = "";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const currentSurface = computed(() => {
      return (props.currentNumSolarPanel * getNumberFromConfig("solar_panel.solar_panel_surface")).toFixed(2);
    });
