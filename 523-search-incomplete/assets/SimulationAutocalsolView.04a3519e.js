import { as as defineComponent, ay as ref, aH as computed, aA as rt, bs as purify, aw as openBlock, aB as createElementBlock, aC as createBaseVNode, aJ as normalizeClass, bt as withDirectives, bu as vModelText, aF as createCommentVNode, ax as createVNode, av as withCtx, aD as createTextVNode, aE as withKeys, au as createBlock, az as useRouter, bo as onBeforeMount, bn as reactive, b1 as onMounted } from "./vendor.ef1f2ae1.js";
...
import { l as legalList, u as useViewsStore, a as useAddressStore, c as useRoofsStore, e as useConsumptionAndProductionStore, h as useAutocalsolStore, i as HeaderEndSimulation } from "./UiHeaderFullScreen.story.502c6599.js";
import { U as UiSpinnerLoading, a as apiPdfService, q as qualitenr, b as qualibat, c as qualifelec, w as warning, d as azimuthForAutocalsol, g as getPeakPower, L as LargeFooter } from "./LargeFooter.6cb53738.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import { v as viewList } from "./views.model.93fd8cf1.js";
import { a as apiService } from "./api.dc335f76.js";
import { u as usePanelsStore } from "./panels.68ee5187.js";
import "./configService.3f321b17.js";
const deleteCircle = "/cooperation_jn_solar/523-search-incomplete/assets/interface-delete-circle.fdda9bfe.svg";
  ...
  setup(__props, { expose }) {
    ...
    async function sendEmail() {
      ...
      if (validEmail.value && !isCheckBoxOnError.value) {
        ...
        if (result !== void 0 && result !== null && result.etat !== void 0 && result.etat !== null && result.etat != "OK") {
    ...
    const __returned__ = { validEmail, isCheckBoxOnError, userEmail, isCheckboxChecked, isLoading, isErrorSendEmail, isEmailSendOnce, errorPicto, checkboxChange, changeError, sendEmail, openPrivacy, CheckBox, get expandIcon() {
      return goToBlack;
    }, get deleteCircle() {
      return deleteCircle;
    }, UiSpinnerLoading, get UiButton() {
      return rt;
    } };
...
const _hoisted_9$1 = /* @__PURE__ */ createBaseVNode("p", { class: "font-normal text-base" }, " J'autorise la transmission de mon adresse mail pour l'envoi de ma simulation. Celle-ci ne sera pas conserv\xE9e. ", -1);
const _hoisted_10$1 = { class: "flex flex-row text-neutral-700" };
const _hoisted_11 = ["src"];
const _hoisted_12 = { class: "flex flex-row justify-center" };
const _hoisted_13 = /* @__PURE__ */ createBaseVNode("span", { class: "text-white text-base font-medium" }, "Recevoir mon rapport en PDF", -1);
const _hoisted_14 = {
  key: 0,
  class: "flex flex-row justify-center"
};
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("span", { class: "text-green-500 text-base font-medium" }, " Vous recevrez vos r\xE9sultats par mail dans les minutes \xE0 venir. ", -1);
const _hoisted_16 = [
  _hoisted_15
];
const _hoisted_17 = {
...
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("span", { class: "text-red-500 text-base font-medium" }, " Une erreur est survenue, veuillez r\xE9essayer. ", -1);
const _hoisted_19 = [
  _hoisted_18
];
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$5, [
    ...
    createBaseVNode("div", _hoisted_3$4, [
      createBaseVNode("div", _hoisted_4$2, [
        ...
        !$setup.validEmail ? (openBlock(), createElementBlock("div", _hoisted_8$1, " Veuillez v\xE9rifier votre adresse mail. ")) : createCommentVNode("v-if", true)
      ]),
      ...
      !$setup.isErrorSendEmail && $setup.isEmailSendOnce ? (openBlock(), createElementBlock("div", _hoisted_14, _hoisted_16)) : $setup.isErrorSendEmail ? (openBlock(), createElementBlock("div", _hoisted_17, _hoisted_19)) : createCommentVNode("v-if", true)
    ])
  ]);
}
...
const Animation = "/cooperation_jn_solar/523-search-incomplete/assets/loading_L.3dee35f4.gif";
...
const fail = "/cooperation_jn_solar/523-search-incomplete/assets/fail.cf81de51.svg";
