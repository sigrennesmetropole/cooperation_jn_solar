...
import { a_ as defineStore, aC as ref, as as defineComponent, aD as useRouter, aw as openBlock, ay as createElementBlock, az as createBaseVNode, aI as toDisplayString, au as createBlock, aG as normalizeClass, a$ as reactive, b3 as onMounted, aQ as Fragment, aR as renderList, ax as createVNode, av as withCtx, aE as createCommentVNode, aA as createTextVNode, b4 as withDirectives, b5 as vModelText, b6 as pushScopeId, b7 as popScopeId, b8 as rt, aY as onBeforeMount } from "./vendor.f81432ef.js";
...
import { S as SimulationSteps } from "./SimulationSteps.1d524d85.js";
...
import { R as RoofAccordion } from "./RoofAccordion.c41760ee.js";
import { B as BoxStep } from "./BoxStep.bb622ee6.js";
import { S as SimulationResult } from "./SimulationResult.5cee3a7f.js";
import { e as expandIcon } from "./expand-small-bigger-retract-smaller-big.77ae2404.js";
import "./StepIllustration.80607b43.js";
...
const useSimulationStore = defineStore("simulation", () => {
  ...
  const maxNumberSolarPanel = ref(6);
...
const iconDelete = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/icon-delete.a0e9c423.svg";
...
class ApiClientService {
  async fetchRoofSurfaceFixtures() {
    return new Promise((resolve) => {
      resolve(
        roofSurfaceFixtures().sort(
          (a, b) => a.favorable < b.favorable ? 1 : -1
        )
      );
    });
  }
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { state, RoofAccordion };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$8, [
    (openBlock(true), createElementBlock(Fragment, null, renderList($setup.state.roofSurfaces, (roofSurface, index) => {
...
const step2 = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/Steps.69ebb06f.jpg";
const validation = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/interface-validation.bd29d758.svg";
const deleted = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/interface-delete.9cc62749.svg";
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { simulationStore, goToThirdStep, ExplanationSelectionObstacles, BoxStep, get economies() {
      return economies;
    }, SimulationResult };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
const _hoisted_4$5 = /* @__PURE__ */ createBaseVNode("span", { class: "text-white text-base font-medium" }, " Calculer mes \xE9conomies d'\xE9nergie ", -1);
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return $setup.simulationStore.currentSubStep == 1 ? (openBlock(), createBlock($setup["ExplanationSelectionObstacles"], { key: 0 })) : $setup.simulationStore.currentSubStep == 2 ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
    createVNode($setup["SimulationResult"], {
      "max-num-solar-panel": $setup.simulationStore.maxNumberSolarPanel,
      "roof-surface": $setup.simulationStore.roofSurface
    }, null, 8, ["max-num-solar-panel", "roof-surface"]),
...
const energySaving1 = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/energy_saving_1.9fe57917.svg";
const energySaving2 = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/energy_saving_2.539272d6.svg";
const energySaving3 = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/energy_saving_3.062cf52b.svg";
...
const rectangle = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/rectangle.34037dc9.svg";
...
const enedisSignature = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/enedis-signature.83ee47b1.svg";
const enedisSpace = "/cooperation_jn_solar/366-simulation-step4-dynamic-component/assets/enedis-personal-space.895856c2.svg";
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("span", { class: "text-black text-base font-medium" }, " Annuler ", -1);
const _hoisted_4 = [
  _hoisted_3
];
const _hoisted_5 = /* @__PURE__ */ createBaseVNode("span", { class: "text-black text-base font-medium" }, " Pr\xE9c\xE9dent ", -1);
const _hoisted_6 = [
  _hoisted_5
];
const _hoisted_7 = /* @__PURE__ */ createBaseVNode("img", {
  class: "",
  src: "/cooperation_jn_solar/366-simulation-step4-dynamic-component/src/assets/icons/interface-arrows-button-right--arrow-right-keyboard.svg",
  alt: ""
}, null, -1);
const _hoisted_8 = { class: "text-white text-base font-medium" };
