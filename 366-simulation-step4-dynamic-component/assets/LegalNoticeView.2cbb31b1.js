import { as as defineComponent, aw as openBlock, ay as createElementBlock, az as createBaseVNode, aB as createStaticVNode, aP as useRoute, aC as ref, aY as onBeforeMount, ax as createVNode, au as createBlock, aE as createCommentVNode } from "./vendor.f81432ef.js";
import { u as useViewsStore, v as viewList } from "./views.c7eb0c82.js";
import { H as HeaderLegalNotice } from "./UiHeaderFullScreen.story.064e6638.js";
...
const _hoisted_1$3 = { class: "flex flex-col gap-12 w-[880px] h-fit bg-white rounded-xl px-8 py-16 mx-auto mt-32 mb-[78px]" };
const _hoisted_2$2 = /* @__PURE__ */ createBaseVNode("h1", { class: "text-[44px] leading-[48px] lmb-12 font-bold" }, " Mentions l\xE9gales ", -1);
const _hoisted_3 = { class: "flex flex-col gap-8 text-base font-normal" };
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("p", null, " Nos devoirs et obligations : toutes les informations obligatoires du pr\xE9sent site internet. ", -1);
...
_sfc_main$4.__file = "src/components/legal/LegalNotice.vue";
const LegalNotice = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/legal/LegalNotice.vue"]]);
const _sfc_main$3 = {};
const _hoisted_1$2 = { class: "flex flex-col gap-12 w-[880px] h-fit bg-white rounded-xl px-8 py-16 mx-auto mt-32 mb-[79px]" };
const _hoisted_2$1 = /* @__PURE__ */ createStaticVNode('<h1 class="text-[44px] leading-[48px] lmb-12 font-bold"> Politique de protection des donn\xE9es personnelles </h1><p>Derni\xE8re mise \xE0 jour : date</p><div class="bg-neutral-50 p-8 border border-neutral-200"><p class="text-base font-normal"> Bienvenue sur lien <a class="underline decoration-1 font-medium" href="" target="_blank">https://...</a></p><p class="text-base font-normal"> Le responsable de traitement de vos donn\xE9es personnelles est Rennes M\xE9tropole (ci-apr\xE8s \xAB nous \xBB). Adresse postale: Rennes M\xE9tropole Service Protection de la donn\xE9e H\xF4tel de Rennes M\xE9tropole 4, avenue Henri Freville CS 93111 35031 Rennes cedex <a class="test-base underline decoration-1 font-medium" href="" target="_blank">Nous contacter</a></p><p><a class="test-base underline decoration-1 font-medium" href="" target="_blank">Voir les mentions l\xE9gales</a></p></div><div class="flex flex-col gap-8"><div class="text-base font-normal"><p class="mb-6"> Dans le cadre de la simulation des \xE9conomies d&#39;\xE9nergie li\xE9es au pr\xE9-dimensionnement d&#39;une installation photovolta\xEFque, vous nous transmettez des informations personnelles : adresse et consommation \xE9lectrique annuelle. Les champs obligatoires sont indiqu\xE9s comme tels dans les formulaires. Nous nous engageons \xE0 ce que la collecte et le traitement de vos donn\xE9es soient effectu\xE9s de mani\xE8re licite, loyale et transparente, conform\xE9ment au <a class="underline decoration-1 font-medium" href="" target="_blank">R\xE8glement europ\xE9en g\xE9n\xE9ral sur la protection des donn\xE9es</a> (\xAB RGPD \xBB) et \xE0 la <a class="underline decoration-1 font-medium" href="" target="_blank">Loi informatiques et Libert\xE9s de 1978 modifi\xE9e</a> (\xAB LIL \xBB). </p><p class="mb-6"> Cette collecte d&#39;information se limite au n\xE9cessaire, conform\xE9ment au principe de minimisation des donn\xE9es. Les d\xE9finitions fournies \xE0 <a class="underline decoration-1 font-medium" href="" target="_blank">l&#39;article 4 du RGPD</a> sont applicables aux pr\xE9sentes. En cas de mise \xE0 jour, nous n&#39;abaisserons pas le niveau de confidentialit\xE9 de mani\xE8re substantielle sans l&#39;information pr\xE9alable des personnes concern\xE9es. </p><p class="mb-6"> Nous nous efforcerons de r\xE9pondre en toute transparence aux questions suivantes : Quelles cat\xE9gories de donn\xE9es personnelles traitons-nous ? Dans quels buts ? Sur quelles bases l\xE9gales ? Quels sont vos droits ? Comment les exercer ? Pendant combien de temps les donn\xE9es sont-elles conserv\xE9es ? Vous trouverez \xE9galement nos engagements en mati\xE8re de sous-traitance, de transferts, de communication \xE0 des tiers et en cas de faille de s\xE9curit\xE9. </p><p> Pour toute pr\xE9cision ou r\xE9clamation, n&#39;h\xE9sitez pas \xE0 <a class="underline decoration-1 font-medium" href="" target="_blank">nous contacter.</a></p></div><h2 class="text-2xl font-bold"> Quelles donn\xE9es personnelles collectons-nous sur la plateforme ? </h2><div class="font-normal"><h3 class="text-xl font-bold mb-2"> Consommation \xE9lectrique annuelle et adresse : </h3><p class="text-base"> Ces donn\xE9es sont renseign\xE9es par l&#39;utilisateur de la Plateforme ou, pour la consommation \xE9lectrique, si l&#39;utilisateur le souhaite, obtenue par connexion au service DataConnect d&#39;Enedis. </p></div><div class="font-normal"><h3 class="text-xl font-bold mb-2">Journaux de connexion :</h3><p class="text-base"> Des donn\xE9es d\xB4utilisation (adresses IP, logs de connexion et d\xB4utilisation) sont collect\xE9es automatiquement sur la Plateforme. </p></div><div class="font-normal"><h3 class="text-xl font-bold mb-2">Cookies :</h3><p class="text-base"> Voir notre <a class="underline decoration-1 font-medium" href="https://fabriquecitoyenne.fr/cookies-page" target="_blank">Politique des cookies.</a></p></div><h2 class="text-2xl font-bold"> Dans quels buts ces donn\xE9es sont-elles collect\xE9es ? </h2></div><div class="font-normal"><h3 class="text-xl font-bold mb-2"> Consommation \xE9lectrique annuelle et adresse : </h3><p class="text-base mb-6"> Ces donn\xE9es sont utilis\xE9es par Rennes M\xE9tropole pour simuler la part de production photovolta\xEFque associ\xE9e au pr\xE9-dimensionnement d&#39;une installation photovolta\xEFque, consomm\xE9e sur place et celle revendue et inject\xE9e sur le r\xE9seau. </p><p class="text-base"> L&#39;outil Captcha prot\xE8ge la Plateforme contre l&#39;inscription en masse de fa\xE7on automatis\xE9. </p></div><p class="text-2xl font-bold"> Pendant combien de temps vos donn\xE9es sont-elles conserv\xE9es ? </p><div class="font-normal text-base"><p class="mb-6"> Les donn\xE9es sont conserv\xE9es uniquement pendant l&#39;utilisation du service propos\xE9 par la Plateforme. </p><p class="mb-6"> \xC0 l&#39;issue de cette utilisation (\xE9tape de simulation), les donn\xE9es personnelles pourront \xEAtre anonymis\xE9es et conserv\xE9es \xE0 des fins statistiques. Sinon, elles feront l&#39;objet d&#39;une suppression d\xE9finitive. Nous pouvons publier, divulguer et utiliser les informations agr\xE9g\xE9es (informations combin\xE9es de telle sorte que personne ne puisse plus \xEAtre identifi\xE9 ou mentionn\xE9) et les informations non personnelles \xE0 des fins d&#39;analyse de l&#39;utilisation de la Plateforme et pour aider \xE0 la planification \xE9nerg\xE9tique du territoire. </p><p> Vous pourrez conserver la trace des informations associ\xE9es \xE0 votre simulation en t\xE9l\xE9chargeant le rapport de synth\xE8se accessible via un bouton &#39;T\xE9l\xE9charger le rapport .pdf&#39; disponible sur la page Tableau de bord. </p></div><p class="text-2xl font-bold"> Quels sont vos droits ? Comment les exercer ? </p><div class="text-base font-normal"><p> Dans les limites pr\xE9vues par la loi, vous pouvez acc\xE9der et obtenir copie des donn\xE9es vous concernant, vous opposer au traitement de ces donn\xE9es, les faire rectifier ou les faire effacer. Vous disposez \xE9galement d&#39;un droit \xE0 la limitation du traitement de vos donn\xE9es. </p><p> Les demandes d&#39;exercice de vos droits peuvent \xEAtre adress\xE9es au responsable de traitement par voie postale : </p><p>Rennes M\xE9tropole</p><p>Service Protection de la donn\xE9e</p><p>H\xF4tel de Rennes M\xE9tropole</p><p>4 avenue Henri Freville</p><p>CS 93111 35031 Rennes Cedex</p><p class="mb-6"><a class="underline decoration-1 font-medium" href="" target="_blank">Nous contacter</a></p><p> Si vous estimez apr\xE8s nous avoir contact\xE9 que les droits sur vos donn\xE9es n\u2019ont pas \xE9t\xE9 respect\xE9s, vous pouvez introduire une r\xE9clamation aupr\xE8s de la CNIL. </p><p><a class="underline decoration-1 font-medium" href="https://www.cnil.fr/fr/les-droits-pour-maitriser-vos-donnees-personnelles" target="_blank">Voir le site de la CNIL pour plus d\xB4informations sur vos droits.</a></p></div><p class="text-2xl font-bold"> Nos engagements en mati\xE8re de sous-traitance, communication et transferts de donn\xE9es. </p><div class="text-base font-normal"><p class="mb-6"> Vos donn\xE9es nominatives sont \xE0 usage interne, elles sont strictement confidentielles et ne peuvent \xEAtre divulgu\xE9es \xE0 des tiers, sauf en cas d&#39;accord express. </p><p class="mb-6"> En cas de communication de vos donn\xE9es personnelles \xE0 un tiers, quelle que soit sa qualit\xE9, nous nous assurerons pr\xE9alablement que ce dernier est tenu d&#39;appliquer des conditions de confidentialit\xE9 identiques aux n\xF4tres. </p><p class="mb-6"> Nous nous engageons \xE0 (i) ce que tout sous-traitant, dont CampToCamp propulsant la Plateforme et l&#39;INES r\xE9alisant la simulation pr\xE9sentent des garanties contractuelles suffisantes et appropri\xE9es pour respecter vos droits, afin que le traitement r\xE9ponde aux exigences du RGPD et (ii) \xE0 respecter les dispositions du RGPD applicables aux transferts des donn\xE9es. </p><p> Sur la base de nos obligations l\xE9gales, vos donn\xE9es personnelles pourront \xEAtre divulgu\xE9es en application d&#39;une loi, d&#39;un r\xE8glement ou en vertu d&#39;une d\xE9cision d&#39;une autorit\xE9 r\xE9glementaire ou judiciaire comp\xE9tente.[GC1] Dans une logique d&#39;ouverture en ligne des informations d\xE9tenues par les acteurs publics et priv\xE9s, vos contributions publiques pourront, <span class="font-medium">apr\xE8s anonymisation</span>, \xEAtre consult\xE9es par via sur le site <a class="underline decoration-1 font-medium" href="https://data.rennesmetropole.fr/page/home" target="_blank">https://data.rennesmetropole.fr/page/home</a>. </p></div><p class="text-2xl font-bold"> Nos engagements en mati\xE8re de sous-traitance, communication et transferts de donn\xE9es. </p><div class="text-base font-normal"><p class="mb-6"> Nous nous engageons \xE0 mettre en \u0153uvre toutes les mesures techniques et organisationnelles appropri\xE9es gr\xE2ce \xE0 des moyens de s\xE9curisation physiques et logistiques permettant de garantir un niveau de s\xE9curit\xE9 adapt\xE9 au regard des risques d&#39;acc\xE8s accidentels, non autoris\xE9s ou ill\xE9gaux, de divulgation, d&#39;alt\xE9ration, de perte ou encore de destruction des donn\xE9es personnelles vous concernant. </p><p> Dans l&#39;\xE9ventualit\xE9 o\xF9 nous prendrions connaissance d&#39;un acc\xE8s ill\xE9gal aux donn\xE9es personnelles vous concernant, stock\xE9es sur nos serveurs ou ceux de nos prestataires, ou d&#39;un acc\xE8s non autoris\xE9 ayant pour cons\xE9quence la r\xE9alisation des risques identifi\xE9s ci-dessus, nous nous engageons \xE0 : </p><ul><li> \xB7 Vous notifier l&#39;incident dans les plus brefs d\xE9lais si cela est susceptible d\u2019engendrer un risque \xE9lev\xE9 pour vos droits et libert\xE9s ; </li><li>\xB7 Examiner les causes de l&#39;incident ;</li><li> \xB7 Prendre les mesures n\xE9cessaires dans la limite du raisonnable afin d&#39;amoindrir les effets n\xE9gatifs et pr\xE9judices pouvant r\xE9sulter dudit incident. </li></ul><p> En aucun cas les engagements d\xE9finis au point ci-dessus ne peuvent \xEAtre assimil\xE9s \xE0 une quelconque reconnaissance de faute ou de responsabilit\xE9 quant \xE0 la survenance de l&#39;incident en question. </p></div>', 13);
const _hoisted_15 = [
  _hoisted_2$1
];
function _sfc_render$3(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$2, _hoisted_15);
}
_sfc_main$3.__file = "src/components/legal/PrivacyLegal.vue";
const Privacy = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/legal/PrivacyLegal.vue"]]);
const _sfc_main$2 = {};
function _sfc_render$2(_ctx, _cache) {
  return "Plan du site";
}
_sfc_main$2.__file = "src/components/legal/SiteMap.vue";
const SiteMap = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/legal/SiteMap.vue"]]);
const _sfc_main$1 = {};
...
function _sfc_render$1(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, _hoisted_13);
}
_sfc_main$1.__file = "src/components/legal/AccessibilityLegal.vue";
const Accessibility = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/legal/AccessibilityLegal.vue"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { viewStore, params, routeParams, legalLink, HeaderLegalNotice, LegalNotice, Privacy, SiteMap, Accessibility };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
