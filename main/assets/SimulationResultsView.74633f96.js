import { as as defineComponent, aw as openBlock, aA as createElementBlock, aB as createBaseVNode, aL as toDisplayString, aC as createTextVNode, aJ as renderSlot, ax as createVNode, av as withCtx, aK as defineStore, ay as ref, b1 as onBeforeMount, au as createBlock, aD as createCommentVNode } from "./vendor.6a09d00b.js";
...
const _hoisted_1$7 = { class: "flex flex-col gap-2 w-[100%] h-fit bg-white rounded-xl p-6 mx-auto shadow-md" };
const _hoisted_2$7 = /* @__PURE__ */ createBaseVNode("p", { class: "font-dm-sans font-bold text-base" }, "Votre consommation actuelle", -1);
const _hoisted_3$7 = {
  id: "consumptionValue",
...
function _sfc_render$7(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$7, [
    _hoisted_2$7,
    createBaseVNode("p", _hoisted_3$7, toDisplayString($setup.consumptionAndProductionStore.annualConsumption) + " kWh/an ", 1)
  ]);
}
_sfc_main$7.__file = "src/components/results/ConsumptionInformation.vue";
const ConsumptionInformation = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/ConsumptionInformation.vue"]]);
...
const _hoisted_1$6 = { class: "flex flex-row gap-8 w-[100%] h-fit bg-white" };
const _hoisted_2$6 = { class: "flex flex-row w-[50%] justify-center h-fit border border-neutral-300 rounded-lg px-5 py-8" };
const _hoisted_3$6 = ["src"];
const _hoisted_4$5 = { class: "flex flex-col w-[50%] h-fit" };
const _hoisted_5$4 = { class: "font-dm-sans text-base font-normal" };
const _hoisted_6$4 = /* @__PURE__ */ createBaseVNode("strong", null, " photovoltaique.info \xA0", -1);
const _hoisted_7$2 = ["src"];
const _hoisted_8$2 = ["src"];
const _hoisted_9$2 = /* @__PURE__ */ createBaseVNode("span", { class: "font-dm-sans text-white text-base font-bold" }, " Visiter le site", -1);
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$6, [
    createBaseVNode("div", _hoisted_2$6, [
      createBaseVNode("img", { src: $setup.photoVoltaique }, null, 8, _hoisted_3$6)
    ]),
...
_sfc_main$6.__file = "src/components/results/PhotoVoltaique.vue";
const PhotoVoltaique = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/PhotoVoltaique.vue"]]);
...
const _hoisted_1$5 = { class: "flex flex-col gap-6 w-[100%] bg-slate-100 rounded-lg p-6 mx-auto" };
const _hoisted_2$5 = { class: "flex flex-row" };
const _hoisted_3$5 = { class: "underline decoration-1 font-medium text-base" };
    ...
    createBaseVNode("div", _hoisted_2$5, [
      createBaseVNode("p", _hoisted_3$5, [
        createBaseVNode("a", {
          ...
          target: "_blank"
        }, " Acc\xE9der \xE0 la page ", 8, _hoisted_4$4)
      ]),
      createBaseVNode("a", {
        href: $setup.props.link,
        target: "_blank"
...
_sfc_main$5.__file = "src/components/results/LabelsProfitability.vue";
const LabelsProfitability = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/LabelsProfitability.vue"]]);
...
const _hoisted_2$4 = /* @__PURE__ */ createBaseVNode("h2", { class: "font-dm-sans font-bold text-2xl" }, " Plus d'informations pour concr\xE9tiser votre projet ", -1);
const _hoisted_3$4 = { class: "flex flex-row gap-8" };
const _hoisted_4$3 = ["src"];
const _hoisted_5$2 = /* @__PURE__ */ createBaseVNode("h2", { class: "font-dm-sans text-2xl font-bold" }, " 3 labels de qualification pour vous guider dans le choix de votre installateur ", -1);
const _hoisted_6$2 = { class: "py-[18px] px-6 flex flex-row justify-between w-[100%] bg-white rounded-xl" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$4, [
    ...
    createBaseVNode("div", _hoisted_3$4, [
      createVNode($setup["LabelsProfitability"], { link: "https://www.photovoltaique.info/fr/preparer-un-projet/quelles-demarches-realiser/choisir-son-installateur/#signes_de_qualite" }, {
        img: withCtx(() => [
          createBaseVNode("img", { src: $setup.qualiLabels }, null, 8, _hoisted_4$3)
        ]),
        title: withCtx(() => [
          _hoisted_5$2
        ]),
...
_sfc_main$4.__file = "src/components/results/GoFurther.vue";
const GoFurther = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/results/GoFurther.vue"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { viewStore, autocalsolStore, consumptionAndProductionStore, addressStore, autocalsolResult, selectedRoof, ConsumptionInformation, GoFurther, SunshineInformation, AutocalsolResult };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
