import { ar as openBlock, as as createElementBlock, at as createBaseVNode, au as createTextVNode, aw as defineComponent, aE as resolveComponent, aC as createBlock, aF as withCtx, aG as createVNode } from "./vendor.99c52613.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
const _sfc_main$1 = {};
const _hoisted_1$1 = { class: "flex flex-col gap-3" };
const _hoisted_2 = /* @__PURE__ */ createBaseVNode("h1", { class: "mt-5 font-dm-sans font-bold text-xl leading-7 text-black" }, " Le saviez-vous ? ", -1);
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("p", { class: "font-dm-sans font-normal text-sm text-black" }, [
