import { ar as openBlock, as as createElementBlock, at as createBaseVNode, au as createTextVNode, av as createStaticVNode, aw as defineComponent, ax as ref, ay as useRouter, az as computed, aA as normalizeClass, aB as withDirectives, aC as vModelCheckbox, aD as createCommentVNode, aE as createBlock, aF as resolveComponent, aG as withCtx, aH as createVNode } from "./vendor.be90047b.js";
...
const _hoisted_4 = { class: "font-normal text-base leading-6 color-black" };
const _hoisted_5 = { class: "flex p-0 gap-3" };
const _hoisted_6 = /* @__PURE__ */ createBaseVNode("span", { class: "text-white text-base font-bold" }, " Commencer ", -1);
const _hoisted_7 = [
  _hoisted_6
];
const _hoisted_8 = {
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("div", _hoisted_5, [
      ...
      $setup.displayError && !$setup.checked ? (openBlock(), createElementBlock("span", _hoisted_8, " Veuillez cocher la case ci-dessus pour accepter les conditions ")) : createCommentVNode("v-if", true)
    ]),
