...
const _hoisted_4$7 = { class: "flex flex-col w-[50%] h-fit" };
    ...
    createBaseVNode("div", _hoisted_2$6, [
      createBaseVNode("p", _hoisted_3$6, [
        createBaseVNode("a", {
          ...
          target: "_blank"
        }, " Acc\xE9der \xE0 la page ", 8, _hoisted_4$6)
      ]),
      createBaseVNode("a", {
        href: $setup.props.link,
        target: "_blank"
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$5, [
    ...
    createBaseVNode("div", _hoisted_3$5, [
      createVNode($setup["LabelsProfitability"], { link: "https://www.photovoltaique.info/fr/preparer-un-projet/quelles-demarches-realiser/choisir-son-installateur/#signes_de_qualite" }, {
        img: withCtx(() => [
          createBaseVNode("img", { src: $setup.qualiLabels }, null, 8, _hoisted_4$5)
        ]),
        title: withCtx(() => [
          _hoisted_5$3
        ]),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { viewStore, roofsStore, autocalsolStore, selectedRoof, autocalsolResult, ConsumptionInformation, GoFurther, SolarCoop, SunshineInformation, AutocalsolResult };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
