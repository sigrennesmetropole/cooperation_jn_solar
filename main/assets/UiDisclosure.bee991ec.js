import { as as defineComponent, az as ref, aw as openBlock, aB as createElementBlock, aC as createBaseVNode, aH as renderSlot, aE as createCommentVNode } from "./vendor.5b209f97.js";
...
const _hoisted_1 = { class: "flex flex-col bg-slate-100 border border-slate-100" };
const _hoisted_2 = { class: "flex flex-row" };
const _hoisted_3 = { class: "flex flex-row items-center justify-center ml-4 h-14" };
