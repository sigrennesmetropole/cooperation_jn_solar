import { ar as openBlock, as as createElementBlock, at as createBaseVNode, au as createTextVNode, av as createStaticVNode, aw as defineComponent, ax as ref, ay as withDirectives, az as vModelCheckbox, aA as createCommentVNode, aB as createBlock, aC as Fragment, aD as resolveComponent, aE as withCtx, aF as createVNode } from "./vendor.e80ae8f3.js";
...
const _hoisted_4$1 = { class: "flex flex-row" };
const _hoisted_5$1 = /* @__PURE__ */ createBaseVNode("h3", { class: "text-2xl font-bold" }, "Conditions d\u2019utilisation", -1);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { checked, displayError, showPopTermOfUse, clickButtonBegin, TermsOfUsePopup };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1 = { class: "flex p-0 gap-3 items-center" };
const _hoisted_2 = { class: "font-normal text-base leading-6 color-black" };
const _hoisted_3 = /* @__PURE__ */ createTextVNode(" J'ai lu et j'accepte les ");
...
const _hoisted_8 = /* @__PURE__ */ createBaseVNode("div", { class: "flex grow" }, null, -1);
