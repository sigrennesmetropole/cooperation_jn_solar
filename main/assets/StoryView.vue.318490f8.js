import { b as useRoute, c as computed, d as defineComponent, u as useCssVars, a as unref, a6 as toRefs, r as ref, o as openBlock, e as createElementBlock, f as createVNode, w as withCtx, I as Icon, n as normalizeClass, g as createBaseVNode, t as toDisplayString, i as defineStore, j as useStorage, x as resolveDirective, y as withDirectives, a7 as useRouter, a8 as useResizeObserver, l as resolveComponent, q as createBlock, h as createCommentVNode, G as normalizeStyle, a1 as withModifiers, A as pushScopeId, B as popScopeId, k as watch, Z as renderSlot, m as withKeys, z as createTextVNode, F as Fragment, p as renderList, J as onMounted, a9 as vModelText, a0 as onUnmounted, aa as VTooltip, ab as createStaticVNode, s as useEventListener, E as reactive, a5 as applyState, ac as toRaw, X as mergeProps, ad as Dropdown, ae as clone, af as omit, ag as useTimeoutFn, ah as onClickOutside, v as isRef, ai as nextTick, aj as Zg, ak as zg, al as jg, am as Wg, Y as resolveDynamicComponent, W as watchEffect, V as markRaw, an as shallowRef, ao as unindent, ap as getHighlighter, aq as Xg, T as Transition, a4 as h, ar as onBeforeUnmount } from "./vendor.6c5e1db1.js";
import { u as useScrollOnActive, B as BaseListItemLink, _ as _export_sfc, a as useStoryStore, i as isMobile, c as BaseSplitPane, b as _sfc_main$y } from "./MobileOverlay.vue2.7d2ff168.js";
import { B as BaseEmpty } from "./BaseEmpty.vue.c20b730f.js";
import { g as getContrastColor, _ as _sfc_main$x, b as SANDBOX_READY, E as EVENT_SEND, S as STATE_SYNC, t as toRawDeep, P as PREVIEW_SETTINGS_SYNC } from "./state.64487cbf.js";
import { d as base, h as histoireConfig, i as isDark, b as clientSupportPlugins } from "./GenericMountStory.vue2.2349fa81.js";
...
const _withScopeId$2 = (n) => (pushScopeId("data-v-c1d28b37"), n = n(), popScopeId(), n);
...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    useCssVars((_ctx) => ({
      "d647bf7e": unref(variant).iconColor,
      "772419ec": unref(settings).backgroundColor
    }));
    const { variant } = toRefs(props);
    const { isActive, targetRoute } = useCurrentVariantRoute(variant);
...
const StoryVariantGridItem = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-c1d28b37"]]);
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    computed(() => {
      var _a2;
      var _a, _b;
      return (_a2 = (_a = story.value.file) == null ? void 0 : _a.docsFilePath) != null ? _a2 : props.standalone && ((_b = story.value.file) == null ? void 0 : _b.filePath);
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
