import { as as defineComponent, ay as ref, aw as openBlock, aB as createElementBlock, aC as createBaseVNode, aK as renderSlot, aF as createCommentVNode, aE as withKeys } from "./vendor.204e41f7.js";
...
const _hoisted_2 = { class: "flex flex-row items-center justify-center h-14" };
const _hoisted_3 = {
  class: "ml-auto flex flex-row items-center justify-center w-11 h-full",
  tabindex: "0"
};
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    class: "flex flex-col bg-slate-100 border border-slate-100 px-4 rounded-lg cursor-pointer",
