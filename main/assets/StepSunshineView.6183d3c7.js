import { a_ as defineStore, aC as ref, as as defineComponent, aD as useRouter, aw as openBlock, ay as createElementBlock, az as createBaseVNode, aI as toDisplayString, au as createBlock, aG as normalizeClass, a$ as reactive, b3 as onMounted, aQ as Fragment, aR as renderList, ax as createVNode, av as withCtx, aE as createCommentVNode, aA as createTextVNode, b4 as withDirectives, b5 as vModelText, b6 as pushScopeId, b7 as popScopeId, aY as onBeforeMount } from "./vendor.8a61dc8b.js";
import { u as usePanelsStore } from "./panels.d313cefe.js";
import { u as useViewsStore, v as viewList } from "./views.1026d8cf.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import { S as SimulationSteps } from "./SimulationSteps.457832e5.js";
...
import { R as RoofAccordion } from "./RoofAccordion.b4a262a6.js";
import { B as BoxStep } from "./BoxStep.37437562.js";
import { S as SimulationResult } from "./SimulationResult.34aced75.js";
import { e as expandIcon } from "./expand-small-bigger-retract-smaller-big.77ae2404.js";
import "./StepIllustration.3a10a9bd.js";
...
class ApiEnedisService {
  ...
  async callApiPost(url, dataPost) {
    const response = await fetch(getUrlBackOffice() + url, {
      method: "POST",
      headers: {
  ...
  async setPRMUser(prm) {
    const data = await this.callApiPost("/api/enedis/user/prm", { prm });
    return data.prm;
  }
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { goToEnedisWebSite, goToEnedisLogin, get enedisSignature() {
