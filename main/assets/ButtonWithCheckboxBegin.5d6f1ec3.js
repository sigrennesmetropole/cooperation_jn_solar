import { aw as openBlock, ay as createElementBlock, az as createBaseVNode, aA as createTextVNode, aB as createStaticVNode, as as defineComponent, aC as ref, aD as useRouter, ax as createVNode, av as withCtx, aE as createCommentVNode, au as createBlock } from "./vendor.8a61dc8b.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper.cdc0426e.js";
import { C as CheckBox } from "./CheckBox.7b190984.js";
const _sfc_main$1 = {};
const _hoisted_1$1 = {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { checked, displayError, showPopTermOfUse, router, isCheckBoxOnError, isCheckboxChecked, clickButtonBegin, checkboxChange, changeError, TermsOfUsePopup, CheckBox };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1 = { class: "flex flex-col gap-6" };
const _hoisted_2 = { class: "font-normal text-base leading-6 color-black" };
const _hoisted_3 = { class: "flex p-0 gap-3" };
const _hoisted_4 = /* @__PURE__ */ createBaseVNode("span", { class: "text-white text-base font-bold" }, " Commencer ", -1);
const _hoisted_5 = [
  _hoisted_4
];
const _hoisted_6 = {
      ...
      text: withCtx(() => [
        createBaseVNode("span", _hoisted_2, [
          ...
          createBaseVNode("span", {
            ...
            onClick: _cache[0] || (_cache[0] = ($event) => $setup.showPopTermOfUse = true)
