import { as as defineComponent, aw as openBlock, aA as createElementBlock, aB as createBaseVNode, aL as toDisplayString, aI as normalizeClass, aG as computed, aV as Fragment, ax as createVNode, aE as createCommentVNode, aC as createTextVNode, aD as withKeys, aJ as renderSlot, av as withCtx, be as onBeforeMount, at as resolveComponent, b0 as createStaticVNode, aH as normalizeStyle, bn as R, au as createBlock, ay as ref, bp as html2pdf } from "./vendor.62ba8b76.js";
import { v as viewList } from "./views.model.a1ba4457.js";
import { f as useConsumptionAndProductionStore, b as useAddressStore, e as useSolarPanelStore, u as useViewsStore, a as useRoofsStore, g as useAutocalsolStore, l as legalList, h as HeaderEndSimulation } from "./UiHeaderFullScreen.story.0adefcde.js";
...
const _hoisted_6$c = { class: "flex flex-row items-center p-0 gap-2.5" };
const _hoisted_7$9 = { class: "font-dm-sans font-bold text-[44px] leading-[48px]" };
    ...
    createBaseVNode("div", _hoisted_4$h, [
      createBaseVNode("div", _hoisted_5$f, [
        createBaseVNode("div", _hoisted_6$c, [
          createBaseVNode("span", _hoisted_7$9, toDisplayString($props.currentNumSolarPanel), 1),
          createBaseVNode("img", {
            class: "w-16 h-16",
...
const _hoisted_6$b = /* @__PURE__ */ createBaseVNode("strong", { class: "underline" }, " photovoltaique.info", -1);
...
const _hoisted_6$9 = { class: "font-dm-sans text-base font-medium text-neutral-900" };
const _hoisted_7$6 = /* @__PURE__ */ createBaseVNode("strong", { class: "underline" }, " \xC9nergies du pays de Rennes ", -1);
...
const _hoisted_6$8 = /* @__PURE__ */ createBaseVNode("p", { class: "font-dm-sans text-base font-normal" }, " Vous pouvez vous faire accompagner par la structure citoyenne Solarcoop qui vous aidera \xE0 trouver la meilleure installation. ", -1);
...
const _hoisted_6$7 = { class: "absolute left-[445px] top-[80px] z-30" };
const _hoisted_7$5 = ["src"];
const _hoisted_8$4 = { class: "mt-8 font-dm-sans relative mr-12" };
...
const _hoisted_6$6 = /* @__PURE__ */ createBaseVNode("div", { class: "border-l-2 border-dashed h-[270px] mx-4 absolute left-[642px] top-[90px] z-30" }, null, -1);
const _hoisted_7$4 = /* @__PURE__ */ createBaseVNode("span", { class: "font-dm-sans font-bold text-sm absolute top-[385px] left-[640px] z-30" }, " Minuit ", -1);
...
const _hoisted_6$4 = { class: "font-bold text-xs" };
function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$9, [
    ...
    createBaseVNode("div", _hoisted_5$6, [
      createBaseVNode("span", _hoisted_6$4, toDisplayString($setup.props.numPage) + " / 6 ", 1)
    ])
  ]);
}
...
const _hoisted_5$5 = /* @__PURE__ */ createBaseVNode("span", { class: "mt-2 font-medium text-sm" }, " Projetez-vous en tant que producteur d\u2019\xE9lectricit\xE9 gr\xE2ce \xE0 l\u2019\xE9nergie solaire photovolta\xEFque ", -1);
const _hoisted_6$3 = { class: "ml-auto" };
const _hoisted_7$2 = ["src"];
const _hoisted_8$2 = { class: "flex flex-col text-center mt-[150px]" };
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const __returned__ = { PdfDivider };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$7 = { class: "flex flex-col mt-[45px]" };
const _hoisted_2$7 = /* @__PURE__ */ createBaseVNode("span", { class: "mt-5 font-bold text-2xl" }, " Votre simulation d\u2019installation photovolta\xEFque ", -1);
...
const _hoisted_5$4 = { class: "flex flex-col gap-3 w-full h-fit bg-white rounded-xl p-6 mx-auto font-dm-sans" };
const _hoisted_6$2 = { class: "flex flex-col gap-3 w-full h-fit bg-white rounded-xl p-6 mx-auto mt-5" };
const _hoisted_7$1 = ["src"];
const _hoisted_8$1 = { class: "mt-[70px]" };
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$6, [
    createCommentVNode(" Header "),
    createVNode($setup["PdfHeader"]),
    createCommentVNode(" Content "),
...
const _hoisted_6$1 = { class: "mt-[300px]" };
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const __returned__ = { props, PdfFooter, PdfHeader, AutocalsolResultGraph };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$4 = { class: "w-[90%] font-dm-sans" };
const _hoisted_2$4 = { class: "flex flex-col gap-2 w-[100%] h-fit bg-white rounded-xl p-6 mt-[100px]" };
const _hoisted_3$3 = /* @__PURE__ */ createBaseVNode("span", { class: "font-bold text-xl mt-10" }, " Comment r\xE9duire au maximum sa facture d'\xE9lectricit\xE9 ? ", -1);
const _hoisted_4$2 = /* @__PURE__ */ createBaseVNode("p", { class: "font-normal text-sm" }, " Votre production solaire varie selon la course du soleil. La nuit, votre consommation est int\xE9gralement soutir\xE9e au r\xE9seau. Pour r\xE9duire au maximum votre facture d'\xE9lectricit\xE9, il vous faut adapter vos habitudes de consommation, par exemple mettre en route vos appareils \xE9lectriques en journ\xE9e au moment de la production photovolta\xEFque. ", -1);
const _hoisted_5$2 = { class: "mt-[150px]" };
...
const _hoisted_2$2 = { class: "font-dm-sans font-medium flex flex-col gap-8 w-[100%] bg-white rounded-xl p-6 mt-[100px]" };
