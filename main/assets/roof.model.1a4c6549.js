import { aL as defineStore, ay as ref, b4 as GeoJSON } from "./vendor.204e41f7.js";
import { c as useRoofsStore } from "./UiHeaderFullScreen.story.6126781a.js";
const useMapStore = defineStore("map", () => {
  const isInitializeMap = ref(false);
  const viewPoint = ref(null);
  const viewPointPrevious = ref(null);
