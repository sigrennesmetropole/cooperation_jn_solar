const __resolved__virtual_storySource_srcComponentsPcaetFigurekeynumberStoryVue = `<script lang="ts" setup>
...
`;
export {
  __resolved__virtual_storySource_srcComponentsPcaetFigurekeynumberStoryVue as default
};
