...
import { q as qualitenr, a as qualibat, b as qualifelec, u as useAutocalsolStore } from "./autocalsol.9ed1e211.js";
import { u as useViewsStore, v as viewList } from "./views.model.65cd082f.js";
import { u as useAddressStore } from "./address.9d0c0bd3.js";
...
import "./layers.624e6cce.js";
import { a as SOLAR_PANEL_POWER } from "./solarPanel.model.5b355558.js";
import { u as useSolarPanelStore, a as apiService } from "./solarPanels.32af4de3.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { viewStore, addressStore, roofsStore, consumptionAndProductionStore, autocalsolStore, router, panelsStore, get isAutocalsolError() {
      ...
      isAutocalsolError = v;
    }, isAutocalsolResult, state, callAutocalsolApi, WaitingAnimation, FailComponent, CertifiedInstaller };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1 = { class: "overflow-auto flex flex-row bg-slate-100 w-full" };
const _hoisted_2 = { class: "w-screen font-dm-sans font-medium flex flex-col overflow-y-scroll gap-6" };
