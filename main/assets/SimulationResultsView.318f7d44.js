import { as as defineComponent, aw as openBlock, aA as createElementBlock, aB as createBaseVNode, aL as toDisplayString, aI as normalizeClass, aG as computed, aE as createCommentVNode, aC as createTextVNode, aD as withKeys, ax as createVNode, aJ as renderSlot, av as withCtx, be as onBeforeMount, at as resolveComponent, aV as Fragment, b0 as createStaticVNode, aH as normalizeStyle, ay as ref, au as createBlock, bp as html2pdf } from "./vendor.62ba8b76.js";
import { v as viewList } from "./views.model.a1ba4457.js";
import { f as useConsumptionAndProductionStore, b as useAddressStore, e as useSolarPanelStore, u as useViewsStore, a as useRoofsStore, g as useAutocalsolStore, l as legalList, h as HeaderEndSimulation } from "./UiHeaderFullScreen.story.5e6f5bd7.js";
...
import { q as qualitenr, a as qualibat, b as qualifelec, w as warning, L as LargeFooter } from "./LargeFooter.15b7a9c9.js";
import { p as potentiel } from "./potentiel.320635bc.js";
import { R as RoofInformationsBox } from "./RoofInformationsBox.6d74b483.js";
import { e as economies } from "./economies.0397e19a.js";
import { a as apiService } from "./api.f4ee6b9e.js";
import { u as useDistrictStore } from "./districtInformations.814d819e.js";
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { props, currentSurface, currentPower, addressStore, blob, get urlImg() {
      return urlImg;
    }, set urlImg(v) {
      urlImg = v;
    }, get installation() {
...
const _hoisted_3$d = /* @__PURE__ */ createBaseVNode("span", { class: "font-bold text-2xl" }, " Votre installation ", -1);
const _hoisted_4$c = { class: "bg-slate-50 border border-slate-100 rounded-lg flex flex-col px-5 py-3 gap-4" };
const _hoisted_5$b = { class: "flex flex-col items-center p-0" };
...
const _hoisted_9$4 = { class: "flex flex-col items-center p-0 gap-1" };
const _hoisted_10$4 = /* @__PURE__ */ createBaseVNode("h4", { class: "font-dm-sans text-lg text-center font-bold w-[140px]" }, " panneaux photovolta\xEFques ", -1);
...
const _hoisted_13$3 = { class: "ml-2" };
...
const _hoisted_15$2 = { class: "font-bold text-base" };
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", _hoisted_4$c, [
      ...
      createBaseVNode("div", _hoisted_13$3, [
        _hoisted_14$2,
        createBaseVNode("span", _hoisted_15$2, toDisplayString($setup.currentSurface) + "m\xB2 ", 1)
      ])
    ]),
    ...
    }, null, 8, _hoisted_16$2)) : createCommentVNode("v-if", true)
  ], 2);
}
...
const _hoisted_20$1 = { class: "font-bold text-3xl mt-2" };
const _hoisted_21$1 = /* @__PURE__ */ createBaseVNode("span", { class: "font-bold text-base" }, " kWh/an ", -1);
const _hoisted_22$1 = /* @__PURE__ */ createBaseVNode("span", { class: "w-[160px] text-sm font-medium text-center h-[60px]" }, [
    ...
    createBaseVNode("div", _hoisted_3$6, [
      ...
      createBaseVNode("div", _hoisted_16$1, [
        ...
        createBaseVNode("div", _hoisted_19$1, [
          createBaseVNode("span", _hoisted_20$1, toDisplayString(Math.round($setup.props.autoConsumed)), 1),
          _hoisted_21$1,
          _hoisted_22$1,
          _hoisted_23
        ])
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const __returned__ = { isLoading, props, solarPanelStore, exportToPDF, get iconDownload() {
      return iconDownload;
    }, SunshineInformation, ConsumptionInformation, GoFurther, SolarCoop, EnergiesRennes, AutocalsolResultGlobal, get economies() {
      return economies;
    }, AutocalsolResultGraph, UiSpinnerLoading, ProductionInformation };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
const _hoisted_8 = { class: "w-[50%] flex flex-col" };
const _hoisted_9 = { class: "w-[50%] flex flex-col" };
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("div", { class: "page-break" }, null, -1);
const _hoisted_11 = { class: "flex flex-col gap-2 w-[90%] h-fit bg-white rounded-xl p-6 mt-10" };
const _hoisted_12 = { class: "flex flex-row items-center gap-2" };
const _hoisted_13 = ["src"];
const _hoisted_14 = /* @__PURE__ */ createBaseVNode("span", { class: "font-bold text-2xl" }, " Votre production d'\xE9nergie ", -1);
const _hoisted_15 = /* @__PURE__ */ createBaseVNode("div", { class: "page-break" }, null, -1);
const _hoisted_16 = { class: "flex flex-col gap-2 w-[90%] h-fit bg-white rounded-xl p-6 mt-10" };
const _hoisted_17 = /* @__PURE__ */ createBaseVNode("span", { class: "font-bold text-xl mt-10" }, " Comment r\xE9duire au maximum sa facture d'\xE9lectricit\xE9 ? ", -1);
const _hoisted_18 = /* @__PURE__ */ createBaseVNode("p", { class: "font-normal text-sm" }, " Votre production solaire varie selon la course du soleil. La nuit, votre consommation est int\xE9gralement soutir\xE9e au r\xE9seau. Pour r\xE9duire au maximum votre facture d'\xE9lectricit\xE9, il vous faut adapter vos habitudes de consommation, par exemple mettre en route vos appareils \xE9lectriques en journ\xE9e au moment de la production photovolta\xEFque. ", -1);
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("div", { class: "page-break" }, null, -1);
const _hoisted_20 = { class: "font-dm-sans font-medium flex flex-col gap-8 w-[90%] h-fit bg-white rounded-xl p-6 mt-10" };
const _hoisted_21 = /* @__PURE__ */ createBaseVNode("div", { class: "page-break" }, null, -1);
const _hoisted_22 = { class: "font-dm-sans font-medium flex flex-col gap-8 w-[90%] bg-white rounded-xl p-6 mt-10 mb-[300px]" };
