import { as as defineComponent, aC as ref, aF as computed, aw as openBlock, ay as createElementBlock, az as createBaseVNode, aG as normalizeClass, b4 as withDirectives, b5 as vModelText, ax as createVNode, av as withCtx, aA as createTextVNode, aY as onBeforeMount } from "./vendor.8a61dc8b.js";
...
const _hoisted_1$3 = { class: "flex flex-col gap-8 px-6 py-12 w-[576px] h-fit bg-slate-50 rounded-xl border border-slate-200" };
const _hoisted_2$1 = /* @__PURE__ */ createBaseVNode("div", { class: "flex flex-col gap-3 text-center" }, [
...
const _hoisted_3$1 = { class: "flex flex-col gap-6" };
...
_sfc_main$3.__file = "src/components/simulation/ConsumptionEmailResult.vue";
const ConsumptionEmailResult = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__file", "/home/runner/work/cooperation_jn_solar/cooperation_jn_solar/src/components/simulation/ConsumptionEmailResult.vue"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "WaitingAnimation",
  setup(__props, { expose }) {
    expose();
    const __returned__ = { ConsumptionEmailResult };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1$2 = { class: "flex flex-col gap-[30px] w-[640px] h-fit bg-white rounded-xl p-8 mx-auto mt-[104px] shadow-md" };
